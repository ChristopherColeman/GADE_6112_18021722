...
namespace Assignment_1
{
    class GameEngine
    {
        ...
        public void RtsGameEngine(Form1 form1, GroupBox groupBox1) //error in previous code, no return type and left as "GameEngine" which brought about a .ctor error for duplication
        {
            this.form1 = form1;
        ...
        public void UpdateDisplay()
        {
            ...
            foreach (Unit u in myMap.units)
            {
                ...
                if (u.GetType() == typeof(MeleeUnit))
                {
                    b.ForeColor = Color.White; //error in previous code, spelt "ForColor"
                }
                else
                {
                    b.ForeColor = Color.Black; //error in previous code, spelt "ForColor"
                }
        ...
        public void UpdateMap()
        {
            ...
            {
                Unit closestUnit = u.Closest(ref myMap.units); //determines which unit is closest to the current unit //error in previous code as this had "Unit"
                ...
                {
                    form.displayInfo(d.Message); //displays unit is dead, removes unit from array //error in previous code as this had "message"
